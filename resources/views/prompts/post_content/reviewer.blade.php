...
- Do NOT flag deliberate choices that follow the brand guidelines above (e.g. an intentional lowercase style, a signature phrase, an on-brand term). Treat those as correct, not errors.
