...
return [
    ...
    'brand' => [
        ...
        'voice_select_one' => '(επιλέξτε ένα)',
        'voice_select_any' => '(επιλέξτε όποια)',
        'voice_group' => [
            'pov' => 'Οπτική γωνία',
        ...
        'preview_description' => 'Μια δείγμα ανάρτηση με τα χρώματα και τη γραμματοσειρά της επωνυμίας σας.',
        'preview_headline' => 'Η επωνυμία σας, σε κάθε ανάρτηση',
        'preview_body' => 'Έτσι συνδυάζονται τα χρώματα και η γραμματοσειρά σας στο παραγόμενο περιεχόμενο.',
        'preview_cta' => 'Μάθετε περισσότερα',
