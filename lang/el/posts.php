...
return [
    ...
    'ai' => [
        ...
        'generate' => [
            ...
            'errors' => [
                ...
                'text_failed' => 'Το AI δεν μπόρεσε να ολοκληρώσει τη σύνταξη αυτής της ανάρτησης. Δεν χρεώθηκε το prompt σας. Δοκιμάστε ξανά.',
                'image_partial' => 'Δημιουργήθηκαν μόνο :done από :expected εικόνες. Το κείμενο του προσχεδίου αποθηκεύτηκε. Δοκιμάστε ξανά τις εικόνες.',
                'image_none' => 'Δεν ήταν δυνατή η δημιουργία των εικόνων. Το κείμενο του προσχεδίου αποθηκεύτηκε. Δοκιμάστε ξανά τις εικόνες.',
                'timeout' => 'Η δημιουργία AI έληξε λόγω χρονικού ορίου. Παρακαλώ δοκιμάστε ξανά.',
                'channel_failed' => 'Δεν ήταν δυνατή η σύνδεση με τη ροή δημιουργίας.',
            ],
        ],
        'review' => [
            ...
            'error' => 'Κάτι πήγε στραβά κατά τον έλεγχο. Δοκιμάστε ξανά.',
            'retry' => 'Δοκιμάστε ξανά',
            'cancel' => 'Ακύρωση',
        ],
        'image_regenerate' => [
            ...
            'source_alt' => 'Τρέχουσα εικόνα υπό επεξεργασία',
            'quick_edits' => [
                'brighten' => 'Κάν\'το πιο φωτεινό',
                'remove_background' => 'Αφαίρεση φόντου',
                'night' => 'Αλλαγή σε νύχτα',
                'warmer' => 'Θερμότεροι τόνοι',
                'sharpen' => 'Όξυνση λεπτομερειών',
            ],
            'cancel' => 'Ακύρωση',
            ...
            'descriptions' => [
                'text_only' => 'Περιγράψτε τη διόρθωση κειμένου. Το τρέχον οπτικό και η θέση στο καρουζέλ θα παραμείνουν ίδια.',
                'image_only' => 'Περιγράψτε το νέο οπτικό. Θα αντικαταστήσει το τρέχον και θα διατηρήσει τη θέση του στο καρουζέλ.',
                'both' => 'Περιγράψτε τις αλλαγές σε κείμενο και οπτικό. Η ενημερωμένη εικόνα θα διατηρήσει τη θέση της στο καρουζέλ.',
            ],
            'modes' => [
                'text_only' => [
                    'label' => 'Μόνο κείμενο',
                    'description' => 'Διατήρηση του τρέχοντος οπτικού και ενημέρωση του κειμένου στην εικόνα.',
                ],
                'image_only' => [
                    'label' => 'Νέο οπτικό',
                    'description' => 'Δημιουργία νέου φόντου, ενώ το κείμενο της εικόνας παραμένει αμετάβλητο.',
                ],
                'both' => [
                    'label' => 'Κείμενο και οπτικό',
                    'description' => 'Δημιουργία νέου φόντου και ενημέρωση του κειμένου της εικόνας.',
                ],
            ],
            'instruction_placeholders' => [
                'text_only' => 'π.χ. Αλλαγή του «ECP» σε «ICP» στον τίτλο.',
                'image_only' => 'π.χ. Αντικατάσταση του φόντου με ένα δάσος στο ξημέρωμα.',
                'both' => 'π.χ. Ενημέρωση του τίτλου και χρήση πιο φωτεινού φόντου γραφείου.',
            ],
            'processing' => [
                'text_only' => 'Ενημέρωση κειμένου εικόνας… αυτό μπορεί να διαρκέσει μερικά δευτερόλεπτα.',
                'image_only' => 'Δημιουργία νέου οπτικού… αυτό μπορεί να διαρκέσει μερικά δευτερόλεπτα.',
                'both' => 'Ενημέρωση κειμένου και οπτικού εικόνας… αυτό μπορεί να διαρκέσει μερικά δευτερόλεπτα.',
            ],
            'submit' => [
                'text_only' => 'Ενημέρωση κειμένου',
                'image_only' => 'Δημιουργία νέου οπτικού',
                'both' => 'Ενημέρωση κειμένου και οπτικού',
            ],
            'success' => [
                'text_only' => 'Το κείμενο της εικόνας ενημερώθηκε.',
                'image_only' => 'Εφαρμόστηκε το νέο οπτικό.',
                'both' => 'Το κείμενο και το οπτικό της εικόνας ενημερώθηκαν.',
            ],
            'mode_label' => 'Τι πρέπει να αλλάξει;',
            'continue_in_background' => 'Συνέχεια στο παρασκήνιο',
            'background_notice' => 'Η αναδημιουργία θα συνεχιστεί στο παρασκήνιο.',
        ],
        'templates' => [
            'image_card' => [
        ...
        'regenerate_caption' => [
            'button_tooltip' => 'Αναδημιουργία λεζάντας',
            'title' => 'Αναδημιουργία λεζάντας',
            'description' => 'Δημιουργήστε μια νέα λεζάντα, διατηρώντας τον έλεγχο του τι εφαρμόζεται στο πρόχειρο.',
            'instruction_label' => 'Οδηγία',
            'instruction_placeholder' => 'Προαιρετικά: π.χ. κάντε το πιο σύντομο',
            'output_label' => 'Νέα λεζάντα',
            'streaming' => 'Γράφουμε τη λεζάντα σας…',
            'error_generic' => 'Δεν ήταν δυνατή η δημιουργία λεζάντας. Δοκιμάστε ξανά.',
            'applied' => 'Η λεζάντα εφαρμόστηκε στο πρόχειρο.',
            'start' => 'Δημιουργία',
            'apply' => 'Εφαρμογή λεζάντας',
            'retry' => 'Αναδημιουργία ξανά',
            'cancel' => 'Άκυρο',
        ],
    ],
    ...
    'edit' => [
        ...
        'preview_disabled' => 'Δεν θα δημοσιευτεί — απενεργοποιημένο για αυτή τη δημοσίευση.',
    ],
    ...
    'formats' => [
        ...
        'telegram_post' => 'Ανάρτηση Telegram',
        'discord_message' => 'Μήνυμα Discord',
    ],
    'wizard' => [
        'title' => 'Δημιουργία δημοσίευσης',
        'description' => 'Επιλέξτε πώς θέλετε να ξεκινήσετε.',
        'scratch_title' => 'Ξεκίνημα από το μηδέν',
        'scratch_description' => 'Γράψτε τη δημοσίευση μόνοι στον επεξεργαστή.',
        'ai_title' => 'Δημιουργία με AI',
        'ai_description' => 'Περιγράψτε την ιδέα σας και το AI θα δημιουργήσει ένα προσχέδιο.',
        'connect_first' => 'Συνδέστε πρώτα έναν κοινωνικό λογαριασμό.',
        'connect_cta' => 'Σύνδεση τώρα',
        'generating_text' => 'Σύνταξη του προσχεδίου σας…',
        'text_ready' => 'Το προσχέδιο είναι έτοιμο — απόδοση εικόνων…',
        'submitting' => 'Έναρξη δημιουργίας…',
        'check_status' => 'Έλεγχος κατάστασης',
        'status_check_failed' => 'Δεν ήταν δυνατός ο έλεγχος της κατάστασης δημιουργίας. Δοκιμάστε ξανά.',
        'credits_exhausted' => 'Τα AI credits εξαντλήθηκαν. Αναβαθμίστε το πρόγραμμά σας για να συνεχίσετε.',
        'need_format' => 'Επιλέξτε μορφή για να συνεχίσετε.',
        'need_account' => 'Επιλέξτε λογαριασμό για να συνεχίσετε.',
        'need_compatible_style' => 'Επιλέξτε στυλ που υποστηρίζει αυτήν τη μορφή.',
        'need_prompt' => 'Περιγράψτε το θέμα της ανάρτησης.',
        'prompt_too_long' => 'Το κείμενό σας είναι πολύ μεγάλο.',
        'style_unsupported_for_format' => 'Μη διαθέσιμο για αυτήν τη μορφή.',
        'prompt_label' => 'Τι θέλετε να δημοσιεύσετε;',
        'prompt_placeholder' => 'π.χ. ανακοίνωση της νέας σελίδας τιμών',
        'format_label' => 'Μορφή',
        'account_label' => 'Λογαριασμός',
        'style_label' => 'Στυλ',
        'images_label' => 'Εικόνες',
        'brand_colors_label' => 'Χρήση χρωμάτων επωνυμίας',
        'brand_references_label' => 'Χρήση αναφορών επωνυμίας',
        'language_label' => 'Γλώσσα',
        'next' => 'Συνέχεια',
        'generate' => 'Δημιουργία δημοσίευσης',
        ...
        'brand_references_uploading' => 'Μεταφόρτωση…',
        'brand_references_empty' => 'Δεν έχουν μεταφορτωθεί ακόμη φωτογραφίες αναφοράς. Επισυνάψτε λογότυπο, προϊόν ή φωτογραφίες σας.',
        'media_none' => 'Καμία (μόνο κείμενο)',
        'media_images' => 'Εικόνες',
    ],
    ...
    'create' => [
        ...
        'steps' => [
            ...
            'loading_image_progress' => 'Δημιουργία εικόνας :done από :expected',
