...
return [
    ...
    'ai' => [
        ...
        'regenerate_caption' => [
            ...
            'output_label' => 'Nouvelle légende',
            'streaming' => 'Rédaction de votre légende…',
            'error_generic' => 'Impossible de générer une légende. Veuillez réessayer.',
            'applied' => 'Légende appliquée à votre brouillon.',
            'start' => 'Générer',
    ...
    'wizard' => [
        ...
        'description' => 'Choisissez comment vous voulez commencer.',
        'scratch_title' => 'Partir de zéro',
        'scratch_description' => 'Rédigez la publication vous-même dans l’éditeur.',
        'ai_title' => 'Générer avec l’IA',
        'ai_description' => 'Décrivez votre idée et l’IA en fera un brouillon.',
        'connect_first' => 'Connectez d’abord un compte social.',
        'connect_cta' => 'Connecter maintenant',
        'generating_text' => 'Rédaction de votre brouillon…',
        'text_ready' => 'Brouillon prêt — rendu des images…',
        'submitting' => 'Démarrage de la génération…',
        'check_status' => 'Vérifier le statut',
        'status_check_failed' => 'Impossible de vérifier le statut de génération. Veuillez réessayer.',
        'credits_exhausted' => 'Crédits IA épuisés. Mettez à niveau votre forfait pour continuer.',
        'need_format' => 'Choisissez un format pour continuer.',
        'need_account' => 'Choisissez un compte pour continuer.',
        'need_compatible_style' => 'Choisissez un style compatible avec ce format.',
        'need_prompt' => 'Décrivez le sujet de la publication.',
        'prompt_too_long' => 'Votre texte est trop long.',
        'style_unsupported_for_format' => 'Indisponible pour ce format.',
        'prompt_label' => 'Que voulez-vous publier ?',
        'prompt_placeholder' => 'ex. annoncer notre nouvelle page tarifaire',
        'format_label' => 'Format',
        'account_label' => 'Compte',
        'style_label' => 'Style',
        'images_label' => 'Images',
        'brand_colors_label' => 'Utiliser les couleurs de la marque',
        'brand_references_label' => 'Utiliser les références de la marque',
        'language_label' => 'Langue',
        'next' => 'Continuer',
        'generate' => 'Générer la publication',
        'failed' => 'La génération a échoué. Réessayez.',
        ...
        'language_variant_swatch_hint' => 'Cette langue applique ses propres couleurs de marque aux images générées.',
