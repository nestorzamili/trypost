...
return [
    ...
    'brand' => [
        ...
        'guidelines_placeholder' => 'Describe your brand personality, content pillars, photography style, CTA approach, and other guidelines for AI-generated content...',
        'guidelines_description' => 'These guidelines are included in AI prompts to keep generated content consistent with your brand.',
        'variants_title' => 'Language Variants',
        'variants_description' => 'Define language-specific color palettes, typography, and visual rules.',
        ...
        'variant_explainer' => 'Une variante est une identité de marque propre à chaque langue — par exemple, une variante japonaise peut utiliser des couleurs et des polices différentes. Lorsque vous générez une publication dans cette langue, sa variante habille automatiquement les images.',
        'variant_language' => 'Language',
        'variant_label' => 'Variant Name',
        'variant_colors' => 'Color Palette',
        'variant_colors_description' => 'Add named colors that AI should use for this language.',
        'variant_roles' => 'Primary Color Roles',
        'add_color' => 'Add Color',
        'remove_color' => 'Remove Color',
        'color_name' => 'Color Name',
        'no_colors' => 'No additional colors added.',
        'variant_headline_font' => 'Headline Font',
        'variant_body_font' => 'Body Font',
        'variant_label_font' => 'Label / Number Font',
        'variant_accent_font' => 'Accent Font (Optional)',
        'variant_visual_notes' => 'Visual Notes',
        'variant_visual_notes_placeholder' => 'Icon style, visual vibes, photography direction, carousel design rules...',
        'variant_confirm_delete' => 'Are you sure you want to delete this brand variant?',
        'flash' => [
            'variant_created' => 'Brand variant created.',
        ...
        'preview_description' => 'Un exemple de publication avec les couleurs et la police de votre marque.',
        'preview_headline' => 'Votre marque, sur chaque publication',
        'preview_body' => 'Voici comment vos couleurs et votre police se combinent sur le contenu généré.',
        'preview_cta' => 'En savoir plus',
