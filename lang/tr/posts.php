...
return [
    ...
    'ai' => [
        ...
        'regenerate_caption' => [
            ...
            'instruction_label' => 'Yönerge',
            'instruction_placeholder' => 'İsteğe bağlı: örn. daha kısa ve öz hale getirin',
            'output_label' => 'Yeni altyazı',
            'streaming' => 'Altyazınız yazılıyor…',
            'error_generic' => 'Altyazı oluşturulamadı. Lütfen tekrar deneyin.',
            'applied' => 'Altyazı taslağınıza uygulandı.',
            'start' => 'Oluştur',
    ...
    'wizard' => [
        ...
        'connect_cta' => 'Şimdi bağla',
        'generating_text' => 'Taslağınız yazılıyor…',
        'text_ready' => 'Taslak hazır — görseller işleniyor…',
        'submitting' => 'Üretim başlatılıyor…',
        'check_status' => 'Durumu kontrol et',
        'status_check_failed' => 'Üretim durumu kontrol edilemedi. Lütfen tekrar deneyin.',
        'credits_exhausted' => 'Yapay zeka kredileri tükendi. Devam etmek için planınızı yükseltin.',
        'need_format' => 'Devam etmek için bir biçim seçin.',
        'need_account' => 'Devam etmek için bir hesap seçin.',
        'need_compatible_style' => 'Bu biçimi destekleyen bir stil seçin.',
        'need_prompt' => 'Gönderinin konusunu açıklayın.',
        'prompt_too_long' => 'Metniniz çok uzun.',
        'style_unsupported_for_format' => 'Bu biçim için kullanılamaz.',
        'prompt_label' => 'Ne paylaşmak istiyorsunuz?',
        'prompt_placeholder' => 'örn. yeni fiyat sayfamızı duyurun',
        'format_label' => 'Biçim',
        'account_label' => 'Hesap',
        'style_label' => 'Stil',
        'images_label' => 'Görseller',
        'brand_colors_label' => 'Marka renklerini kullan',
        'brand_references_label' => 'Marka referanslarını kullan',
        'language_label' => 'Dil',
        'next' => 'Devam',
        'generate' => 'Gönderi oluştur',
        'failed' => 'Oluşturma başarısız. Lütfen tekrar deneyin.',
