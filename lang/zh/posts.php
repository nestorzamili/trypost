...
return [
    ...
    'wizard' => [
        ...
        'connect_cta' => '立即连接',
        'generating_text' => '正在编写草稿…',
        'text_ready' => '草稿已就绪 — 正在渲染图片…',
        'submitting' => '正在开始生成…',
        'check_status' => '检查状态',
        'status_check_failed' => '无法检查生成状态。请重试。',
        'credits_exhausted' => 'AI 额度已用尽。请升级套餐以继续。',
        'need_format' => '请选择一种格式以继续。',
        'need_account' => '请选择一个账户以继续。',
        'need_compatible_style' => '请选择支持该格式的样式。',
        'need_prompt' => '描述这条帖子的主题。',
        'prompt_too_long' => '你的提示词太长了。',
        'style_unsupported_for_format' => '此格式不可用。',
        'prompt_label' => '你想发布什么?',
        'prompt_placeholder' => '例如: 发布我们的新定价页面',
        'format_label' => '格式',
        'account_label' => '账号',
        'style_label' => '风格',
        'images_label' => '图片',
        'brand_colors_label' => '使用品牌颜色',
        'brand_references_label' => '使用品牌参考',
        'language_label' => '语言',
        'next' => '继续',
        'generate' => '生成帖子',
        'failed' => '生成失败,请重试。',
