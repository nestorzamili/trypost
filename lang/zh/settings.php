...
return [
    ...
    'brand' => [
        ...
        'guidelines' => '品牌指南',
        'guidelines_placeholder' => '描述品牌个性、内容支柱、摄影风格、行动号召方式，以及其他会影响 AI 生成内容的规则……',
        'guidelines_description' => '这些指南会加入 AI 提示词，帮助生成内容保持品牌一致性。',
        'variants_title' => '语言变体',
        'variants_description' => '为不同语言定义专属的配色、字体和视觉规则。',
        'add_variant' => '添加变体',
        'edit_variant' => '编辑变体',
        'delete_variant' => '删除变体',
        ...
        'variant_label' => '变体名称',
        'variant_colors' => '配色方案',
        'variant_colors_description' => '添加 AI 应用于此语言的命名颜色。',
        'variant_roles' => '主要颜色角色',
        'add_color' => '添加颜色',
        'remove_color' => '移除颜色',
        'color_name' => '颜色名称',
        'no_colors' => '尚未添加其他颜色。',
        'variant_headline_font' => '标题字体',
        'variant_body_font' => '正文字体',
        'variant_label_font' => '标签 / 数字字体',
        'variant_accent_font' => '强调字体（可选）',
        'variant_visual_notes' => '视觉备注',
        'variant_visual_notes_placeholder' => '图标风格、视觉氛围、摄影方向、轮播设计规则……',
        'variant_confirm_delete' => '确定要删除此品牌变体吗？',
        'flash' => [
            'variant_created' => '品牌变体已创建。',
            'variant_updated' => '品牌变体已更新。',
            'variant_deleted' => '品牌变体已删除。',
        ],
        'reference_photos_title' => '品牌参考照片与人物形象',
        'reference_photos_description' => '上传品牌形象人物、创始人（如 Sara）或活动的照片。AI 生成图片时将使用这些照片来保持角色面貌与视觉风格一致。',
        'upload_reference_photo' => '添加参考照片',
        'no_reference_photos' => '尚未上传参考照片',
        'no_reference_photos_hint' => '上传 1–5 张清晰的个人肖像、特写或活动照片，为 AI 帖子和轮播图生成提供视觉参考。',
        'upload_first_photo' => '上传参考照片',
