...
return [
    ...
    'ai' => [
        ...
        'regenerate_caption' => [
            ...
            'instruction_label' => '지시',
            'instruction_placeholder' => '선택 사항: 예: 더 간결하게 작성',
            'output_label' => '새 캡션',
            'streaming' => '캡션을 작성하는 중…',
            'error_generic' => '캡션을 생성할 수 없습니다. 다시 시도해 주세요.',
            'applied' => '캡션이 초안에 적용되었습니다.',
            'start' => '생성',
            'apply' => '캡션 적용',
            'retry' => '다시 생성',
            'cancel' => '취소',
    ...
    'wizard' => [
        ...
        'connect_cta' => '지금 연결',
        'generating_text' => '초안 작성 중…',
        'text_ready' => '초안 준비 완료 — 이미지 렌더링 중…',
        'submitting' => '생성 시작 중…',
        'check_status' => '상태 확인',
        'status_check_failed' => '생성 상태를 확인할 수 없습니다. 다시 시도해 주세요.',
        'credits_exhausted' => 'AI 크레딧이 소진되었습니다. 계속하려면 플랜을 업그레이드하세요.',
        'need_format' => '계속하려면 형식을 선택하세요.',
        'need_account' => '계속하려면 계정을 선택하세요.',
        'need_compatible_style' => '이 형식을 지원하는 스타일을 선택하세요.',
        'need_prompt' => '게시물 내용을 설명하세요.',
        'prompt_too_long' => '프롬프트가 너무 깁니다.',
        'style_unsupported_for_format' => '이 형식에서는 사용할 수 없습니다.',
        'prompt_label' => '무엇을 게시할까요?',
        'prompt_placeholder' => '예: 새 가격 페이지 소개',
        'format_label' => '형식',
        'account_label' => '계정',
        'style_label' => '스타일',
        'images_label' => '이미지',
        'brand_colors_label' => '브랜드 색상 사용',
        'brand_references_label' => '브랜드 레퍼런스 사용',
        'language_label' => '언어',
        'next' => '계속',
        'generate' => '게시물 생성',
        'failed' => '생성에 실패했습니다. 다시 시도하세요.',
