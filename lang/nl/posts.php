...
return [
    ...
    'ai' => [
        ...
        'regenerate_caption' => [
            ...
            'output_label' => 'Nieuw bijschrift',
            'streaming' => 'Je bijschrift wordt geschreven…',
            'error_generic' => 'We konden geen bijschrift genereren. Probeer het opnieuw.',
            'applied' => 'Bijschrift toegepast op je concept.',
            'start' => 'Genereren',
    ...
    'wizard' => [
        ...
        'connect_cta' => 'Nu verbinden',
        'generating_text' => 'Je concept wordt geschreven…',
        'text_ready' => 'Concept klaar — afbeeldingen renderen…',
        'submitting' => 'Genereren starten…',
        'check_status' => 'Status controleren',
        'status_check_failed' => 'Kon generatiestatus niet controleren. Probeer het opnieuw.',
        'credits_exhausted' => 'AI-tegoed opgebruikt. Upgrade je abonnement om door te gaan.',
        'need_format' => 'Kies een format om door te gaan.',
        'need_account' => 'Kies een account om door te gaan.',
        'need_compatible_style' => 'Kies een stijl die dit format ondersteunt.',
        'need_prompt' => 'Beschrijf waar de post over gaat.',
        'prompt_too_long' => 'Je prompt is te lang.',
        'style_unsupported_for_format' => 'Niet beschikbaar voor dit format.',
        'prompt_label' => 'Wat wil je posten?',
        'prompt_placeholder' => 'bijv. onze nieuwe prijspagina aankondigen',
        'format_label' => 'Formaat',
        'account_label' => 'Account',
        'style_label' => 'Stijl',
        'images_label' => 'Afbeeldingen',
        'brand_colors_label' => 'Merkkleuren gebruiken',
        'brand_references_label' => 'Merkreferenties gebruiken',
        'language_label' => 'Taal',
        'next' => 'Doorgaan',
        'generate' => 'Bericht genereren',
        'failed' => 'Genereren mislukt. Probeer het opnieuw.',
