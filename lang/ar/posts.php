...
return [
    ...
    'ai' => [
        'change_applied' => 'تم تطبيق تغيير الذكاء الاصطناعي.',
        'undo' => 'تراجع',
        'generate' => [
            ...
            'errors' => [
                ...
                'text_failed' => 'تعذّر على الذكاء الاصطناعي إكمال كتابة هذا المنشور. لم يتم خصم أي رصيد. يرجى المحاولة مرة أخرى.',
                'image_partial' => 'تم إنشاء :done من أصل :expected صور فقط. تم حفظ نص المسودة. أعد محاولة إنشاء الصور.',
                'image_none' => 'تعذّر إنشاء الصور. تم حفظ نص المسودة. أعد محاولة إنشاء الصور.',
        ...
        'review' => [
            ...
            'applied' => 'تم التطبيق',
            'no_longer_matches' => 'لم يعد هذا الاقتراح يطابق نصك الحالي.',
            'error' => 'حدث خطأ أثناء المراجعة. يرجى المحاولة مرة أخرى.',
            'retry' => 'حاول مرة أخرى',
            'cancel' => 'إلغاء',
        ],
        'image_regenerate' => [
            ...
            'descriptions' => [
                'text_only' => 'صفح النص المطلوب تعديله. سيبقى التصميم الحالي وموقعه في الكاروسيل كما هو.',
                'image_only' => 'صف التصميم الجديد. سيستبدل التصميم الحالي ويحتفظ بموقعه في الكاروسيل.',
                'both' => 'صف تغييرات النص والتصميم. ستحتفظ الصورة المحدَّثة بموقعها في الكاروسيل.',
            ],
            'modes' => [
                'text_only' => [
                    'label' => 'النص فقط',
                    'description' => 'الاحتفاظ بالتصميم الحالي وتحديث النص على الصورة.',
                ],
                'image_only' => [
                    'label' => 'تصميم جديد',
                    'description' => 'توليد خلفية جديدة مع إبقاء نص الصورة دون تغيير.',
                ],
                'both' => [
                    'label' => 'النص والتصميم',
                    'description' => 'توليد خلفية جديدة وتحديث نص الصورة.',
                ],
            ],
            'instruction_placeholders' => [
                'text_only' => 'مثال: تغيير «ECP» إلى «ICP» في العنوان.',
                'image_only' => 'مثال: استبدال الخلفية بغابة عند شروق الشمس.',
                'both' => 'مثال: تحديث العنوان واستخدام خلفية مكتبية أكثر إشراقًا.',
            ],
            'processing' => [
                'text_only' => 'جارٍ تحديث نص الصورة... قد يستغرق هذا بضع ثوانٍ.',
                'image_only' => 'جارٍ توليد تصميم جديد... قد يستغرق هذا بضع ثوانٍ.',
                'both' => 'جارٍ تحديث نص الصورة وتصميمها... قد يستغرق هذا بضع ثوانٍ.',
            ],
            'submit' => [
                'text_only' => 'تحديث النص',
                'image_only' => 'توليد تصميم جديد',
                'both' => 'تحديث النص والتصميم',
            ],
            'success' => [
                'text_only' => 'تم تحديث نص الصورة.',
                'image_only' => 'تم تطبيق التصميم الجديد.',
                'both' => 'تم تحديث نص الصورة وتصميمها.',
            ],
            'mode_label' => 'ما الذي يجب تغييره؟',
            'continue_in_background' => 'المتابعة في الخلفية',
            'background_notice' => 'ستستمر عملية إعادة التوليد في الخلفية.',
        ],
        'templates' => [
            'image_card' => [
                'name' => 'منشور صورة',
        ...
        'regenerate_caption' => [
            'button_tooltip' => 'إعادة توليد التعليق',
            'title' => 'إعادة توليد التعليق',
            'description' => 'إنشاء تعليق جديد مع بقائك متحكمًا فيما يُطبَّق على المسودة.',
            'instruction_label' => 'التعليمات',
            'instruction_placeholder' => 'اختياري: مثال: اجعله أكثر إيجازًا',
            'output_label' => 'تعليق جديد',
            'streaming' => 'جارٍ كتابة تعليقك…',
            'error_generic' => 'تعذّر إنشاء التعليق. يرجى المحاولة مرة أخرى.',
            'applied' => 'تم تطبيق التعليق على مسودتك.',
            'start' => 'توليد',
            'apply' => 'تطبيق التعليق',
            'retry' => 'إعادة التوليد مرة أخرى',
            'cancel' => 'إلغاء',
        ],
    ],
    ...
    'edit' => [
        ...
        'preview_disabled' => 'لن يُنشر — معطَّل لهذا المنشور.',
    ],
    ...
    'formats' => [
        ...
        'telegram_post' => 'منشور تيليجرام',
        'discord_message' => 'رسالة ديسكورد',
    ],
    'wizard' => [
        'title' => 'إنشاء منشور',
        'description' => 'اختر كيف تريد البدء.',
        'scratch_title' => 'البدء من الصفر',
        'scratch_description' => 'اكتب المنشور بنفسك في المحرر.',
        'ai_title' => 'التوليد بالذكاء الاصطناعي',
        'ai_description' => 'صف فكرتك وسيقوم الذكاء الاصطناعي بصياغتها لك.',
        'connect_first' => 'اربط حسابًا اجتماعيًا أولًا.',
        'connect_cta' => 'الاتصال الآن',
        'generating_text' => 'جارٍ كتابة مسودتك…',
        'text_ready' => 'المسودة جاهزة — جارٍ عرض الصور…',
        'submitting' => 'بدء التوليد…',
        'check_status' => 'التحقق من الحالة',
        'status_check_failed' => 'تعذر التحقق من حالة التوليد. يرجى المحاولة مرة أخرى.',
        'credits_exhausted' => 'نفدت أرصدة الذكاء الاصطناعي. قم بترقية خطتك للمتابعة.',
        'need_format' => 'اختر تنسيقًا للمتابعة.',
        'need_account' => 'اختر حسابًا للمتابعة.',
        'need_compatible_style' => 'اختر نمطًا يدعم هذا التنسيق.',
        'need_prompt' => 'صِف موضوع المنشور.',
        'prompt_too_long' => 'الوصف طويل جدًا.',
        'style_unsupported_for_format' => 'غير متاح لهذا التنسيق.',
        'prompt_label' => 'ماذا تريد أن تنشر؟',
        'prompt_placeholder' => 'مثال: أعلن عن صفحة الأسعار الجديدة',
        'format_label' => 'التنسيق',
        'account_label' => 'الحساب',
        'style_label' => 'النمط',
        'images_label' => 'الصور',
        'brand_colors_label' => 'استخدام ألوان العلامة التجارية',
        'brand_references_label' => 'استخدام مراجع العلامة التجارية',
        'language_label' => 'اللغة',
        'next' => 'متابعة',
        'generate' => 'توليد المنشور',
        'failed' => 'فشل التوليد. يرجى المحاولة مرة أخرى.',
    ...
    'create' => [
        ...
        'steps' => [
            ...
            'loading_image_progress' => 'جارٍ إنشاء الصورة :done من :expected',
