...
return [
    ...
    'ai' => [
        'change_applied' => 'Alteração da IA aplicada.',
        'undo' => 'Desfazer',
        'generate' => [
        ...
        'review' => [
            ...
            'applied' => 'Aplicada',
            'no_longer_matches' => 'Essa sugestão não corresponde mais ao seu texto atual.',
            'error' => 'Algo deu errado durante a revisão. Tente novamente.',
        ...
        'image_regenerate' => [
            ...
            'source_alt' => 'Imagem em edição',
            'quick_edits' => [
                'brighten' => 'Deixar mais claro',
                'remove_background' => 'Remover o fundo',
                'night' => 'Mudar para noite',
                'warmer' => 'Tons mais quentes',
        ...
        'regenerate_caption' => [
            ...
            'output_label' => 'Nova legenda',
            'streaming' => 'Escrevendo sua legenda…',
            'error_generic' => 'Não foi possível gerar uma legenda. Tente novamente.',
            'applied' => 'Legenda aplicada ao seu rascunho.',
            'start' => 'Gerar',
    ...
    'wizard' => [
        ...
        'connect_cta' => 'Conectar agora',
        'generating_text' => 'Escrevendo seu rascunho…',
        'text_ready' => 'Rascunho pronto — renderizando imagens…',
        'submitting' => 'Iniciando geração…',
        'check_status' => 'Verificar status',
        'status_check_failed' => 'Não foi possível verificar o status da geração. Tente novamente.',
        'credits_exhausted' => 'Créditos de IA esgotados. Atualize seu plano para continuar.',
        'need_format' => 'Escolha um formato para continuar.',
        'need_account' => 'Escolha uma conta para continuar.',
        'need_compatible_style' => 'Escolha um estilo compatível com este formato.',
        'need_prompt' => 'Descreva sobre o que é a publicação.',
        'prompt_too_long' => 'Seu texto é longo demais.',
        'style_unsupported_for_format' => 'Indisponível para este formato.',
        'prompt_label' => 'O que você quer publicar?',
        'prompt_placeholder' => 'ex.: anunciar nossa nova página de preços',
        'format_label' => 'Formato',
        'account_label' => 'Conta',
        'style_label' => 'Estilo',
        'images_label' => 'Imagens',
        'brand_colors_label' => 'Usar cores da marca',
        'brand_references_label' => 'Usar referências da marca',
        'language_label' => 'Idioma',
        'next' => 'Continuar',
        'generate' => 'Gerar publicação',
        'failed' => 'A geração falhou. Tente novamente.',
        ...
        'language_variant_swatch_hint' => 'Este idioma aplica suas próprias cores de marca às imagens geradas.',
        'brand_references_title' => 'Referências da marca',
        'brand_references_description' => 'Anexe imagens de referência para guiar a geração de IA (ex.: logotipo, produto, estilo).',
        'brand_references_attach' => 'Anexar foto',
        'brand_references_uploading' => 'Enviando…',
        'brand_references_empty' => 'Nenhuma foto de referência enviada ainda. Anexe seu logotipo, produto ou fotos de perfil.',
        'media_none' => 'Nenhuma (somente texto)',
